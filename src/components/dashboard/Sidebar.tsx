...
export default function Sidebar({
  ...
  useEffect(() => {
    try {
      ...
      if (typeof parsed.prioritiesCollapsed === "boolean")
        setPrioritiesCollapsed(parsed.prioritiesCollapsed);
      if (typeof parsed.groupsCollapsed === "boolean")
        setGroupsCollapsed(parsed.groupsCollapsed);
      if (typeof parsed.taskTypesCollapsed === "boolean")
        setTaskTypesCollapsed(parsed.taskTypesCollapsed);
    } catch {
  ...
  return (
    <>
      ...
      >
                        ...
                        {priorities.length > 0 ? (
                          <PriorityList
                            ...
                            onDeletePriority={(id) =>
                              confirmDelete(
                                id,
                                priorities.find((p) => p.id === id)?.name || "",
                                "priority",
                              )
                            }
        ...
        >
          ...
          <button
            ...
            onClick={() =>
              onNavigate(activeView === "settings" ? "dashboard" : "settings")
            }
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "0.75rem" }}>
                <button
                  type="submit"
                  disabled={saving || !priorityName.trim()}
      ...
      {itemToDelete && (
        <ConfirmDeleteModal
          titleKey={
            itemToDelete.type === "priority"
              ? "delete_priority_title"
